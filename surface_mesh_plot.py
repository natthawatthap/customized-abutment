...
ax_xy.add_collection3d(Poly3DCollection(your_mesh.vectors))
ax_xy.set_xlabel('X')
ax_xy.set_ylabel('Y')
ax_xy.set_zlabel('Z')
...
ax_yz.add_collection3d(Poly3DCollection(your_mesh.vectors))
ax_yz.set_xlabel('Y')
ax_yz.set_ylabel('Z')
ax_yz.set_zlabel('X')
...
ax_xz.add_collection3d(Poly3DCollection(your_mesh.vectors))
ax_xz.set_xlabel('X')
ax_xz.set_ylabel('Z')
ax_xz.set_zlabel('Y')
...
ax_upper.add_collection3d(Poly3DCollection(your_mesh.vectors))
...
ax_lower.add_collection3d(Poly3DCollection(your_mesh.vectors))
...
scale_slider = Slider(fig.add_axes([0.2, 0.1, 0.6, 0.03]), 'Scale', 0.1, 10.0, valinit=1.0)
